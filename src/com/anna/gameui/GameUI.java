...
import com.anna.listeners.KeyboardListener;
import com.anna.listeners.TickListener;
import com.anna.observers.EggObserver;
import com.anna.observers.GameObservable;
import com.anna.observers.ShotObserver;
import com.anna.sprites.Egg;
import com.anna.sprites.Shot;
...
public class GameUI extends JPanel implements IGameUI {
    Image image = new ImageIcon("src/com/anna/images/Lives.png").getImage();
    ...
    public void moveLeft(){
        if(gameState.ship.position.x>10) gameState.ship.position.x-=5;
    }

    public void moveRight(){
        if(gameState.ship.position.x<getWidth()-100) gameState.ship.position.x+=5;
    }
    ...
    @Override
    public void resume(){
        if( gameState.timer!=null)  gameState.timer.restart();
    }
