...
public class Ship extends Sprite {
    final static Image alive = new ImageIcon("src/com/anna/images/ship.png").getImage();
    final static Image boom = new ImageIcon("src/com/anna/images/boom.png").getImage();
